...
class LettersController extends Controller
{
    ...
    {
        return $this->getLetters('pensiun');
    }
    ...
    public function actionDownload($id)
    {
        ...
        switch ($letter->type) {
            ...
            case 'pensiun':
                $letter->lampiran = 1;
                $file = 'Usulan_Pensiun_' . $letter->id . '.docx';
                $docx_path = $this->createFilePensiun($letter, $template_path, $file);
                break;
            default:
    ...
    private function createFilePensiun($letter, $template_path, $file)
    {
        $templateProcessor = new \PhpOffice\PhpWord\TemplateProcessor($template_path . '/surat_usulan_pensiun.docx');
